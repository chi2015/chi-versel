...
const app = express()
  ...
  .use('/poker-chips-counter', express.static(path.join(__dirname, 'poker-chips-counter')))
  .use('/superfrog', express.static(path.join(__dirname, 'superfrog')))
  .use('/metromap-builder', express.static(path.join(__dirname, 'metromap-builder')))
  .set('views', path.join(__dirname, 'views'))
  .set('view engine', 'ejs')
  .get('/', (req, res) => res.render('pages/chi', { menu }))
