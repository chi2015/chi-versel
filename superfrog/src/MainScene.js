...
class MainScene extends Phaser.Scene {
  ...
  onPlayerDied() {
    ...
    this.gameEnded = true;
    SFX.gameover();
    this.time.delayedCall(700, () => this.scene.start('GameOverScene', { win: false, score: this.score }));
  }
  ...
  completeLevel() {
    ...
    this.time.delayedCall(900, () => this.scene.start('GameOverScene', { win: true, score: this.score }));
  }
